...
test_that("sim hierarchical parameters with constraint", {
  set.seed(0)
  out <- hbl_sim_hierarchical(
    n_study = 2,
    n_group = 3,
  ...
  expect_equal(length(out$tau), 3)
})

test_that("sim hierarchical parameters without constraint", {
  set.seed(0)
  out <- hbl_sim_hierarchical(
    n_study = 2,
    n_group = 3,
...
test_that("sim hierarchical unstructured + ar1", {
  set.seed(0)
  out <- hbl_sim_hierarchical(
    n_study = 2,
    n_group = 3,
...
test_that("sim hierarchical ar1 + diagonal", {
  set.seed(0)
  out <- hbl_sim_hierarchical(
    n_study = 2,
    n_group = 3,
