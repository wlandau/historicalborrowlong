#' @title Longitudinal independent MCMC
#' @export
#' @family mcmc
#' @description Run the longitudinal independent model with MCMC.
...
#' @inheritParams hbl_sim_independent
