...
* $\Lambda$: Cholesky factor of the $T \times T$ block of the correlation matrix of the observed data for the current (non-historical) study.
...
If you do set a small $s_\tau$, be aware that the marginal probability mass of each $\tau_k$ may pile up at the uniform prior upper bound. This is generally a sign of poor prior specification in Bayesian models, and you can monitor it with `hbl_plot_tau()`.
